...
@section('content')
    ...
    <form class="bg-gray-100 shadow-2xl p-4 rounded-lg" action="{{ route('games.destroy', $game) }}" method="post">
        @csrf
        @method('delete')
        ...
        <div class="flex gap-8 items-center">
            ...
            <a class="text-blue-500 hover:underline" href="{{ route('games.show', $game) }}">No... take me back</a>
        </div>
    </form>
@endsection
