...
class GamesController extends Controller
{
    ...
    public function markcomplete(Game $game)
    {
        ...
        //Vervelend kiezen: index of show? Show is verwarrend indien je onder games.show > other games table op mark (in)complete klikt. De show wordt dan die van het gewijzigde spel ipv het spel waar je zat.
        //Oplossing is back() = vorige view.
    }
